...
//                return new ChallengeResult();
        ...
        public async Task<IActionResult> UpdateRole(string id, [FromBody] RoleViewModel role)
        {
            if (ModelState.IsValid)
            {
                ...
                Mapper.Map<RoleViewModel, IdentityRole>(role, appRole);
        ...
        public async Task<IActionResult> CreateRole([FromBody] RoleViewModel role)
        {
            if (ModelState.IsValid)
            {
                ...
                IdentityRole appRole = Mapper.Map<IdentityRole>(role);
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            IdentityRole appRole = await this._accountManager.GetRoleByIdAsync(id);
