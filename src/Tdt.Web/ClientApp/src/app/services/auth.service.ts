...
export class AuthService {
  ...
  private _endpointFactory: EndpointFactory;
  ...
  constructor(private router: Router, private configurations: ConfigurationService, private localStorage: LocalStoreManager, private injector: Injector) {
